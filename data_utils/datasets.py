...
if __name__ == '__main__':
    ...
    #val_data = Blender(data_dir=data_dir, split='val', factor=0, batch_type='single_image')
    #val_dataloader = DataLoader(dataset=val_data, batch_size=1, shuffle=False, pin_memory=True, num_workers=1)
